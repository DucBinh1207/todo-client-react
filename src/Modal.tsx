...
const Modal: React.FC<ModalProps> = ({ isOpen, onClose, children }) => {
  ...
  return ReactDOM.createPortal(
    <div className="bg-custom-bg z-1000 fixed bottom-0 left-0 right-0 top-0">
      <form
        action=""
      ...
      >
        <div className="flex flex-col gap-[15px]">
          ...
          <p>
            ...
            a placeat provident asperiores aperiam, sunt maiores, iusto
            accusamus nisi recusandae facere. Similique nulla at laboriosam
            minima nostrum repudiandae distinctio natus?
          </p>
        </div>
